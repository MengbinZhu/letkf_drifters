...
REAL(r_size),SAVE :: sigma_obsv=1000.0d0  !-1.0d0    !STEVE: use a negative value with option "DO_NO_VERT_LOC"
...
! REAL(r_size),PARAMETER :: gross_error=3.0d0 ! number of standard deviations   (Use for OSSEs)
